      ...
      <div className="w-full max-w-md space-y-8 px-2 sm:px-0">
        ...
        <section className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] border border-gray-100 dark:border-slate-800 shadow-sm space-y-8">
           ...
           <div className="space-y-6">
              <div className="p-4 bg-gray-50/50 dark:bg-slate-800/30 rounded-2xl border border-gray-100 dark:border-slate-800/50 flex justify-between items-center transition-all">
                 <div className="flex items-center gap-3">
                    <div className="p-2 bg-blue-100 dark:bg-blue-900/30 text-blue-600 rounded-xl shadow-inner">
                    ...
                    <span className="text-sm font-bold text-slate-600 dark:text-slate-300">Email registrado</span>
                 </div>
                 <span className="text-xs font-black text-slate-400 truncate max-w-[150px]">{user.email}</span>
              </div>
